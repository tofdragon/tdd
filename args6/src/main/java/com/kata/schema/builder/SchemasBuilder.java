...
public final class SchemasBuilder {
    ...
    public SchemasBuilder stringSchema(final String flag, String defaultValue) {
        schemas.add(new StringSchema(flag, defaultValue));
        return this;
    }
    ...
    public SchemasBuilder integerSchema(final String flag, final String defaultValue) {
        schemas.add(new IntegerSchema(flag, defaultValue));
        return this;
    }
    ...
    public SchemasBuilder listIntegerSchema(final String flag, String defaultValue) {
        schemas.add(new ListIntegerSchema(flag, defaultValue));
        return this;
    }

    public SchemasBuilder listStringSchema(final String flag, String defaultValue) {
        schemas.add(new ListStringSchema(flag, defaultValue));
        return this;
    }
